...
$this->menu=array(
	...
	array('label'=>'Update AcervoDigital', 'url'=>array('update', 'id'=>$model->idacervo)),
	array('label'=>'Delete AcervoDigital', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->idacervo),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage AcervoDigital', 'url'=>array('admin')),
);
?>

<h1>Detalle de Acervo Digital</h1> 
...
*/
	...
	if(isset($numInventario)){
		...
		//'data'=>$model, 		
			...
			'duracion'=>CHtml::encode($model->duracion),
	...
	echo "<div class='btn_ejemplar' style='text-align:right; padding: 30px;'>";
	    ...
	    'booster.widgets.TbButton',
		    array(
		        ...
		        'context' => 'primary',                
		        'url' => Yii::app()->createUrl('/acervoDigital/updateInventario', array("id"=>$valor->idacervo)),                
...
echo "<div class='btn_agregar' style='text-align: center'>";
 ...
 $this->widget(
    ...
    array(
        ...
        'context' => 'primary',             
        'url' => Yii::app()->createUrl('/acervoDigital/acervo', array("id"=>$model->idacervo)),  //array ("id")     y no idacervo        
    )
); echo ' ';

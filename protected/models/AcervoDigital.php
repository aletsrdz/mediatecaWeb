...
/**
 * This is the model class for table "acervo_digital".
 *
 * The followings are the available columns in table 'acervo_digital':
 ...
 */
class AcervoDigital extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('titulo, catalogo, material, idioma', 'required'),
			array('idacervo, catalogo, material, idioma', 'numerical', 'integerOnly'=>true),
			array('titulo, autor_personal, autor_corporativo, edicion, isbn, descripcion_area, serie, fondo, acento, tipo_formato, duracion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idacervo, catalogo, material, idioma, titulo, autor_personal, autor_corporativo, edicion, isbn, descripcion_area, serie, fondo, acento, tipo_formato, duracion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AcervoDigital the static model class
	 */

...
class Entrada extends CActiveRecord
{
	...
	public function validarAcceso($attribute, $params){
		...
		{	
        	...
        	$this->addError('idaprendiente', 'El aprendiente '.$this->attributes['idaprendiente'].' ya se encuentra dentro de la MEDIATECA y no ha registrado su salida');        	        	
        }	
	...
	public function validarInscripcion($attribute, $params)
	{
        ...
        {
        	$this->addError('idaprendiente', 'El aprendiente '.$this->attributes['idaprendiente'].' NO esta inscrito, favor de inscribirse');     
        }	

...
class Salida extends CActiveRecord
{
	...
	public function validarSalida($attribute, $params){
		...
		//if (Entrada::model()->exists($criteria))					
			$this->addError('idaprendiente', 'ValidarSalida - El aprendiente '.$this->attributes['idaprendiente'].'
			- idEntrada '.$this->attributes['identrada'].'   no ha registrado su entrada a la Mediateca');     	
		}	
	}//validar Salida
